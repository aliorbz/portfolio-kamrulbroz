  ...
  return (
    <section className="scroll-reveal py-4">
      <div className="bg-[#fdfaf5] rounded-[2.5rem] sm:rounded-[3rem] p-8 sm:p-16 lg:p-24 flex flex-col items-center text-center shadow-sm">
        ...
        <p className="text-black font-bold mb-12 max-w-xl text-base sm:text-lg">Feel free to contact me on any queries. I'm available for new projects or just for chatting.</p>
